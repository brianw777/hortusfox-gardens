...
<div class="margin-vertical">
	...
	<div class="is-inline-block is-action-button-margin"><a class="button is-mint-green" href="javascript:void(0);" onclick="window.vue.showPerformBulkUpdate('last_weeded', '{{ __('app.bulk_set_weeded') }}', '{{ __('app.set_weeded') }}');">{{ __('app.set_weeded') }}</a></div>
